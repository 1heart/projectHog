...
def make_averaged(fn, num_samples=200):
...
##    return a
##
##print (make_averaged(testfn,1000)(1))
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    NUM_ROLLS otherwise.
    """
    potentialYou = score + (1 + largestDigit (opponent_score))
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # if (score + opponent_score)%7 == 0:
    #     return 4
    if (potentialYou + opponent_score) % 7 == 0 and potentialYou != 0: #if you can give them 4-sided, do it
        return 0
    elif potentialYou == opponent_score/2 or opponent_score == potentialYou/2: #if you can swap well, do it
        if potentialYou < opponent_score + 0: # adds margin to the swap
            return 0
        else:
            return 5
    # elif (score+opponent_score) % 7 == 0 and score != 0: #if you're rolling 4sided
    #     return 4
    else:
